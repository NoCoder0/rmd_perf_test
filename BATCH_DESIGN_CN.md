...
- 默认矩阵：块数100、200、400、600、800、1200、1600、2400、4800、6400、9600；先遍历1024B，再遍历656B，共22个case。支持显式块数列表、起止/步长和单case；提供任一范围参数才启用范围扫描。mode、links、K、pipeline保持一次运行的配置，不做额外组合扫描。每case默认20 verify、100 warmup、1000 measure。
